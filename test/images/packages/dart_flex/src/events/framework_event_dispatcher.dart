...
class FrameworkEventDispatcherMixin {
  ...
  FrameworkEventDispatcher eventDispatcher;
  
  bool hasObserver(String type) => eventDispatcher.hasObserver(type);

  void observeEventType(String type, Function eventHandler) => eventDispatcher.observeEventType(type, eventHandler);

  void ignoreEventType(String type, Function eventHandler) => eventDispatcher.ignoreEventType(type, eventHandler);

  void notify(FrameworkEvent event) => eventDispatcher.notify(event);
